  ...
  return (
    <Section id="newsfeed">
      <Container width="1400px">
        <SectionHeading>
          <Heading content="Latest Stories" />
            <Text content="Printajo is the leading graphic design company for vehicle branding in Dubai. We offer full and partial vehicle branding, graphics and wraps with only quality materials in Dubai.
"/>
        </SectionHeading>
        <Grid>
          {posts.map((post) => (
